...
import {
  ...
  shortDetectorFamily,
  shortVariantId,
} from './image-processing-detector-cache.js';
import {
  compareDetectorVariant,
  countOverlappingFinders,
  countSignatureSource,
  detectorTimingMeasurement,
  detectorUnit,
  finderSignature,
  mergeDetectorVariant,
  parseFinderSignature,
  summarizeFloodOverlap,
} from './image-processing-detector-model.js';
import {
  type BinaryViewSignal,
  emptyScalarFusionMeasurement,
  emptySharedArtifactMeasurement,
  measureBinarySignals,
  measureScalarFusion,
  measureScalarStats,
  type ScalarStatsMeasurement,
  summarizeSharedArtifacts,
} from './image-processing-measurements.js';
import {
  measureBinaryReadVariants,
  runDecodeMeasurement,
  stripDecodedTexts,
  summarizeTimingSpans,
} from './image-processing-scan-measurements.js';
import type {
  BenchComponentStats,
  DenseLabelScratch,
  ...
  DetectorVariantSummary,
  FloodCandidateMeasurement,
  ImageProcessingAssetResult,
  ImageProcessingConfig,
  ImageProcessingFocus,
  ImageProcessingScalarSummary,
  ImageProcessingSummary,
  ImageProcessingTimingSummary,
  ImageProcessingTotals,
  ImageProcessingVariantSummary,
  ImageProcessingViewSummary,
  MatcherCandidateMeasurement,
  ScanlineLabelScratch,
    ...
    runAsset: async ({ asset, config, cache, signal, log }) => {
      ...
      const binaryRead =
        config.focus === 'binary-bit-hot-path'
          ? await measureBinaryReadVariants(viewBank, viewIds, asset.id, log, yieldToDashboard)
          : null;
...
const compareVariant = compareDetectorVariant;
